...
HD_PWD='C:/Users/apsgrp9/Desktop/basic_progs/TWO_BOARDS/HAL_symbols_480/vga_connector/vga_connector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmod_add.tcl
