...
HD_PWD='C:/Users/apsgrp9/Desktop/basic_progs/TWO_BOARDS/HAL_symbols_480/vga_connector/vga_connector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_add.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pmod_add.tcl -notrace
